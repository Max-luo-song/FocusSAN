...
def draw(
    ...
    fx = 888.8890923394097
    fy = 1000.0002288818359
    cx = 320.0
    cy = 240.0
    y = d * 2 * cy / (2 * fy)
    x = d * 2 * cx / (2 * fx)
    ...
    # print("occupied_voxels:", occupied_voxels.max())
...
def arg_parser():
    ...
    parser.add_argument('--file', type=str, required=False, default="/data3/gls/code/habitate_demo/blender_v0.1/scene1/save_local_occ/00002.pkl")
